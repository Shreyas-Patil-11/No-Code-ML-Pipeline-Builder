...
// import { Cpu, AlertCircle, Info, GitBranch, TrendingUp } from 'lucide-react';
...
//   const [dtMinSamples, setDtMinSamples] = useState(2);

//   const models = [
//     {
//       id: 'logistic_regression',
//       name: 'Logistic Regression',
//       description: 'Best for binary classification with linear decision boundaries',
//       icon: TrendingUp,
//     },
//     {
//       id: 'decision_tree',
//       name: 'Decision Tree',
//       description: 'Good for complex patterns and feature importance analysis',
//       icon: GitBranch,
//     },
//   ];
...
//     const params = selectedModel === 'logistic_regression'
//       ? { maxIter: parseInt(lrMaxIter), C: parseFloat(lrC) }
//       : { maxDepth: dtMaxDepth ? parseInt(dtMaxDepth) : null, minSamplesSplit: parseInt(dtMinSamples) };
...
//             <Info size={20} />
//             Please split your data first before selecting a model.
//           </div>
//         </div>
//       </div>
//     );
...
//             Model trained successfully! See results below.
//           </div>
//         )}
...
//               >
//                 <IconComponent className="model-card-icon" size={48} />
//                 <h4>{model.name}</h4>
...
//                   type="number"
//                   value={lrMaxIter}
//                   onChange={(e) => setLrMaxIter(e.target.value)}
//                   min="100"
//                   max="10000"
//                 />
//               </div>
...
//             <div className="params-grid">
//               <div className="form-group">
//                 <label>Max Depth (empty = unlimited)</label>
//                 <input
//                   type="number"
//                   value={dtMaxDepth}
//                   onChange={(e) => setDtMaxDepth(e.target.value)}
//                   min="1"
//                   max="50"
...
//                   type="number"
//                   value={dtMinSamples}
//                   onChange={(e) => setDtMinSamples(e.target.value)}
//                   min="2"
//                   max="100"
//                 />
//               </div>
